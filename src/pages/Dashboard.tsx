...
const Dashboard: React.FC = () => {
  ...
  // Local state to keep spinner visible for at least 500ms
  ...
  // Manage delayed spinner visibility when isUpdating changes
  useEffect(() => {
    if (isUpdating) {
      setShowSpinner(true);
    } else {
      // Keep spinner visible for 500ms after isUpdating turns false
            ...
            {showSpinner ? (
              ...
              <>
                <p className="text-gray-600 text-sm mb-4">
                  Track your nutrition journey and body composition changes over time.
                </p>
